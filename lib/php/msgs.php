<?php
	/*************************************************************
	* msgs displays html messages according to the level and     *
	...
	**************************************************************/
	...
	// External Display Functions //
		function err($string) { $this->msg($string, "danger", "Error:"); }		// Error Display Function
		function wrn($string) { $this->msg($string, "warning", "Warning:"); }	// Warning Display Function
		function inf($string) { $this->msg($string, "info", "Info:"); }			// Info Display Function
		function sca($string) { $this->msg($string, "success", "Success:"); }	// Success Display Function
	}
?>
