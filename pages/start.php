<?php
	...
	****************************************************************/
	...
	$_pgobj->query("SELECT pic FROM at_userdata WHERE username = '$_session->username' AND pic IS NOT NULL");
	if($_pgobj->rows == 1) if(file_exists("$_path->images/uploaded/". $_pgobj->result[0]['pic'])) $user_pic_path = "$_path->images/uploaded/". $_pgobj->result[0]['pic'];
			...
			<div class="left_col">
				<div class="navbar nav_title">
					<a href="./" class="site_title">
						...
						<span><?= $site_title_base ;?></span><span style="font-size: 17px;"> - Delta</span>
					</a>
				</div>
...
<?php	if($_session->groupname=='tech') { ?>
						...
						<li><a href="./?p=20"><i class="fa fa-edit"></i> <?= $_msg->lang("Register") ." ". $_msg->lang("Customers"); ?> </a></li>
...
<?php		} ?>
						...
						<li class="parent"><a><i class="fa fa-edit"></i> <?= $_msg->lang("Register"); ?> <span class="fa fa-chevron-down"></span></a>
							<ul class="nav child_menu" style="display: none">
								<li><a href="./?p=20"><?= $_msg->lang("Customers"); ?></a></li>
								<li><a href="./?p=21"><?= $_msg->lang("Technicians"); ?></a></li>
<?php		if($_session->groupname=='full') { ?>
								<li><a href="./?p=22"><?= $_msg->lang("Administrators"); ?></a></li>
<?php		} ?>
							</ul>
						</li>
						<li class="parent"><a><i class="fa fa-wrench"></i> <?= $_msg->lang("Tools"); ?> <span class="fa fa-chevron-down"></span></a>
							<ul class="nav child_menu" style="display: none">
								...
								<li><a href="./?p=31"><?= $_msg->lang("Network"); ?></a></li>
								<li><a href="./?p=32"><?= $_msg->lang("System"); ?></a></li>
						...
						<li class="parent"><a><i class="fa fa-gear"></i> <?= $_msg->lang("Settings"); ?> <span class="fa fa-chevron-down"></span></a>
							<ul class="nav child_menu" style="display: none">
								...
								<li><a href="./?p=41"><?= $_msg->lang("Installation"); ?></a></li>
								<li><a href="./?p=42"><?= $_msg->lang("Manage Plans"); ?></a></li>
								<li><a href="./?p=43"><?= $_msg->lang("Form Fields"); ?></a></li>
							</ul>
						</li>
<?php	} ?>
...
<?php } ?>
									...
									<ul class="dropdown-menu pull-right">
										<li><a href="./?p=50"><i class="fa fa-user"></i> <?= $_msg->lang("Profile"); ?></a></li>
										<li><a href="./?p=60"><i class="fa fa-question-circle"></i> <?= $_msg->lang("Help"); ?></a></li>
										<li><a href="./?p=off"><i class="fa fa-sign-out"></i> <?= $_msg->lang("Sign Out"); ?></a></li>
									</ul>
								</li>
								<li class="dropdown">
									<a class="user-session dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
...
<?php
	...
	for($i=0; $i<count($lang_files); $i++) {
		...
		echo str_repeat("\t", 11) ."<li><a href=\"javascript:void(0);\" label=\"$lang_code\">$lang_name</a></li>\n";
				...
				<footer>
					<div>
						<p class="fa pull-right">
							<span style="letter-spacing: 1.2px;"> <?= $site_title_base; ?> - Delta </span>
							<span class="fa-ellipsis-v"></span>
							<span> Developed by Andre Breier </span>
						</p>
					</div>
					<div class="clearfix"></div>
				</footer>
